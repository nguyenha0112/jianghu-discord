...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("work")
    .setDescription("Tu luyen dao tu hien tai de nhan tai nguyen."),
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        {
          name: "🧬 Linh căn",
          value: `${result.reward.spiritRootName}${result.reward.spiritRootMatches ? "\nHợp mệnh, tu luyện hanh thông." : "\nKhông phải đạo tu hợp mệnh."}`,
          inline: true
        },
        ...
        {
          name: "🧭 Trạng thái",
          value: result.reward.realmCapReached ? "Đã chạm giới hạn. Dùng /dotpha để tiếp tục." : "Có thể tiếp tục tu luyện.",
          inline: true
        }
      )
